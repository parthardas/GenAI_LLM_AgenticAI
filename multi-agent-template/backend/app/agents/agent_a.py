...
def agent_a_node(state:GraphState) -> GraphState:
    """
    Processes the given state for agent A, determines which tool to invoke based on user input,
    ...
    if "tool 1" in user_input.lower():
        ...
        response = "Please specify 'tool 1' or 'tool 2' in your input for agent A."
