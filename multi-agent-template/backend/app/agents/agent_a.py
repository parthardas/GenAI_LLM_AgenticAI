...
def tool_two(data: str) -> OutputSchema:
    """
    Processes the input data string and returns an OutputSchema object with a formatted result.
    Args:
        data (str): The input string to be handled by the tool.
    Returns:
        OutputSchema: An object containing the result string indicating it was handled by tool_two.
    """
